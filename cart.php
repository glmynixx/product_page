...
<main class="container" style="padding: 2rem 0; max-width: 800px; margin: 0 auto;">
    <div class="section-header">
        ...
        <?php else: ?>
            <table style="width: 100%; border-collapse: collapse; margin: 2rem 0; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                <thead>
                        ...
                        <tr style="border-bottom: 1px solid #ddd;">
                            ...
                            <td style="padding: 1rem;">
                                <form method="POST" style="display:inline;">
                                    ...
                                    <input type="number" name="quantity" value="<?php echo intval($item['quantity']); ?>" min="1" style="width: 60px; padding: 0.5rem; border: 1px solid #ddd; border-radius: 4px;">
                                    <button type="submit" name="update_quantity" style="padding: 0.25rem 0.5rem; margin-left: 0.5rem; background: #2F4F4F; color: white; border: none; border-radius: 4px; cursor: pointer;">Update</button>
                                </form>
                            </td>
